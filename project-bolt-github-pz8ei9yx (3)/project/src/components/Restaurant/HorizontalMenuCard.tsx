    ...
    <div className="w-[220px] flex-shrink-0 bg-black rounded-xl overflow-hidden relative shadow-lg group cursor-pointer" onClick={handleCardClick}>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black via-black/90 to-transparent">
        <div className="flex items-center justify-between">
          ...
          {item.outOfStock ? (
            <span className="text-[10px] font-medium text-white/60">Out of stock</span>
          ) : itemCount > 0 ? (
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-[10px] font-medium bg-white text-black hover:bg-opacity-90 transition-colors"
            >
              Add
            </button>
          )}
