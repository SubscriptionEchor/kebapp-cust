...
const HorizontalCard: React.FC<RestaurantProps> = ({
  ...
  return (
    <div onClick={handleCardClick} className={`w-[180px] flex-shrink-0 shadow-md bg-white rounded-xl overflow-hidden card-hover animate-scale-in`}>
      <div className="relative overflow-hidden">
        ...
        {campaigns?.length > 0 && (
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <div className={`px-2.5 py-1.5 rounded-lg backdrop-blur-sm ${campaigns.length > 1
