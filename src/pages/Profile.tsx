...
import { DELETE_ACCOUNT, TOGGLE_USER_NOTIFICATIONS } from '../graphql/queries';
...
const Profile: React.FC = () => {
  ...
  const { profile, setProfile, refetchProfile } = useUser();
            ...
            <div className="bg-white rounded-lg p-6 mx-4 w-full max-w-sm">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-lg font-medium ${isLoading ? 'bg-gray-400 text-gray-200' : 'bg-secondary text-white'
                    }`}
                  disabled={isLoading}
                >
                  {isLoading ? (
